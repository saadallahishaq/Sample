...
if games_df.empty:
    ...
    if odds_df.empty:
        ...
        with tab1:
            ...
            fig_ml.update_layout(hovermode="x unified", width=1200)
        ...
        with tab2:
            ...
            fig_prob.update_layout(title="Win Probability (Market Sentiment)", template="plotly_dark", 
                                 yaxis_tickformat='.1%', hovermode="x unified", width=1200)
        ...
        with tab3:
            ...
            fig_sp.update_layout(hovermode="x unified", width=1200)
